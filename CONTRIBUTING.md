This resource was made by the Adaptive Learning community and wouldn't be possible without you! We appreciate and recognize [all contributors](https://github.com/amirHossein-Ebrahimi/awesome-adaptive-learnings/graphs/contributors).
...
- Publication links are (article|conference) followed by : and then year e.g. `paper:2020`
